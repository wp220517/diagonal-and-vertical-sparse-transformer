...
class IEMOCAP(Base_database):
    def __init__(self, matdir=None, matkey=None, length=None, state=None, meta_csv_file='/media/wp/data/item/Key-Sparse-Transformer/name_label_text.csv'):
        self.length = length
    ...
    def get_wavfile_path(self, name):
        ...
        wavpath = '/media/wp/data/dataset/IEMOCAP/{}/sentences/wav/{}'.format(ses, clue)
